...
\usepackage{orcidlink} % ORCID icon (modern way)
\usepackage{lipsum}
...
\IEEEauthorblockA{\textit{Department of System Analysis and Information}\\
\textit{and Analytical Technologies}\\
\textit{of National Technical University}\\
\textit{``Kharkiv Polytechnic Institute''}\\
Kharkiv, Ukraine\\
...
\linebreakand
\IEEEauthorblockN{Yurii Parzhyn}
\IEEEauthorblockA{\textit{Postdoctoral Fellow}\\
\textit{School of Computer and Cyber Sciences}\\
\textit{Augusta University}\\
Augusta, USA\\
yparzhyn@augusta.edu}
\and
\IEEEauthorblockN{Kyrylo Perevoznyk}
\IEEEauthorblockA{\textit{Department of System Analysis and Information}\\
\textit{and Analytical Technologies}\\
\textit{of National Technical University}\\
\textit{``Kharkiv Polytechnic Institute''}\\
...
\begin{IEEEkeywords}
explainable AI (XAI), artificial neural networks, hypergraph models, few-shot learning, structural reduction, graph matching
\end{IEEEkeywords}
