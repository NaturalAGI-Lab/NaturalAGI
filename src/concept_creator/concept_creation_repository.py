...
class ConceptCreationRepository:
    ...
    def _create_concept(self, tx: ManagedTransaction, session_id: str) -> str:
        ...
        self._create_concept_node(tx, concept_id, session_id, nodes)
    ...
    def _create_concept_node(self, tx: ManagedTransaction, concept_id: str, session_id: str, nodes: List[dict]):
        ...
        """
        tx.run(query, concept_id=concept_id, session_id=session_id, node_data=node_data)