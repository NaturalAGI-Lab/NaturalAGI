...
class ContourAnalysisRepository:
    ...
    def _create_relative_params(tx, min_angle_point):
        ...
        while True:
            if len(processed_vectors):
                ...
                next_vector, coords = ContourAnalysisRepository.find_next_vector(
            ...
            result = ContourAnalysisRepository.calculate_and_set_relative_params(
    ...
    def calculate_and_set_relative_params(tx, min_angle_point, next_vector, coords):
        ...
        x_vect, y_vect = ContourAnalysisRepository.calculate_vector_value(
        ...
        (
            ...
            vertical_plane,
            quadrant,
        ) = ContourAnalysisRepository.calculate_half_plane_and_quadrant(
            starting_x, starting_y, ending_x, ending_y
        )
        logging.debug(
